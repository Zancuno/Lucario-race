...
LucaCombo = WeaponAbility:new()

function LucaCombo:init()
  self.comboStep = 1
...
function LucaCombo:update(dt, fireMode, shiftHeld)
...
function LucaCombo:shouldActivate()
...
function LucaCombo:readyFlash()
  animator.setGlobalTag("bladeDirectives", self.flashDirectives)
  self.flashTimer = self.flashTime
end

function LucaCombo:computeDamageAndCooldowns()
  local attackTimes = {}
